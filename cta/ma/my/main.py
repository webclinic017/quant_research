...
from ma.my.ma_strategy import MAStrategy
from ma.my.data import Data
from ma.my.plot import plot
...
def backtest(df_baseline: DataFrame, df_dict, params):
    ...
    strategy = MAStrategy(broker, params)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--conf', type=str, default="ma/params.yml", help="参数文件路径")
