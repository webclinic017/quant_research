...
from macd.my.macd_strategy import MACDStrategy
from macd.my.prepare_data import macd
from macd.my.plot import plot
from utils import utils
from utils.data_loader import load_index, load_stock
...
def backtest(df_baseline: DataFrame, df_dict, params):
    ...
    strategy = MACDStrategy(broker, params)
...
def main(params):
    ...
    df_data = load_stock(params.code,adjust='hfq')
    df_data = macd(df_data,params)
    df_dict[params.code] = df_data
...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--conf', type=str, default="macd/params.yml", help="参数文件路径")
